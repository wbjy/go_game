...
func main(){
	...
	pNetAgent := PoolAndAgent.CreateNetAgent("0.0.0.0:4101")
	pLogicPool := PoolAndAgent.CreateMsgPool(quit, uint32(mytype.EnumAppType_Gate), myAppId)
	pRouterAgent := PoolAndAgent.CreateRouterAgent("127.0.0.1:2001")
